...
//import com.rits.nextnumbergeneratorservice.dto.InventoryList;
...
//import com.rits.processorderrelease.dto.*;
//import com.rits.processorderrelease.exception.ShopOrderReleaseException;
//import com.rits.processorderrelease.model.MessageDetails;
//import com.rits.processorderrelease.model.SOReleaseMessageModel;
//import com.rits.processorderrelease.producer.PcuHeaderProducer;
//import com.rits.processorderrelease.producer.ShopOrderProducer;
...
//                            Bno pcuNumber = Bno.builder().pcuBo("PcuBO:" + releaseRequest.getSite() + "," + existingSerialPcus.get(i).getPcuNumber()).build();
...
//                            .build();
//
//                    inventoryList = webClientBuilder
//                            .build()
//                            .post()
//                            .uri(newNxtNumberUrl)
...
//                            newPcuNumbers.add(inventoryList.get(i).getInventory());
//                            Bno pcuNumber = Bno.builder().pcuBo("PcuBO:" + releaseRequest.getSite() + "," + inventoryList.get(i).getInventory()).build();
//                            pcuNumberList.put(pcuNumber.getPcuBo(), (int) inventoryList.get(i).getQty());
//                        }
//                    }
//                }
//
...
//                                .currentSequence(inventoryList.get(inventoryList.size() - 1).getCurrentSequence())
