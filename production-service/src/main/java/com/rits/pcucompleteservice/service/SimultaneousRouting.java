...
@Service
@Lazy
public class SimultaneousRouting {
    ...
    public MessageModel executeSimultaneousLogic(PcuRequest pcuRequest, PcuCompleteRequestInfo pcuCompleteReqWithBO, RoutingRequest routingRequest, List<RoutingStep> operationQueueList) throws Exception {
        ...
        return MessageModel.builder().message_details(new MessageDetails("Exception Occurred in Operation Complete", "S")).build();
    }
