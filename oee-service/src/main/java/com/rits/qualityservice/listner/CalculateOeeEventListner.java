package com.rits.qualityservice.listner;
...
@Slf4j
public class CalculateOeeEventListner {
    private final WebClient.Builder webClientBuilder;
    @Value("${integration-service.uri}/logkafkafrommessage")
    private String integrationServiceFromMessage;
    @EventListener
    public void handleOeeEvent(QualityRequestList qualityRequestList){
        Message<QualityRequestList> message = new Message<>("OeeCalculation", qualityRequestList);
